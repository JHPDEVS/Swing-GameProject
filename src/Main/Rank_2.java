...
public class Rank_2 extends javax.swing.JFrame {
      ...
      initComponents();
       // System.out.println(nicknameValue);
        ...
        if(nicknameValue!= "게스트") {
            if(game2.getBestPoint() == "-1") {
               NickName.setText(nicknameValue+"님 전적이 존재하지 않습니다");
            } else {
             NickName.setText(nicknameValue+"님 기록은 " + game2.getBestPoint() +"점입니다");
            }
        } else {
    ...
    private void getRank() {
        ...
        String query = "SELECT `nickname`,`rsppoint` FROM `users` WHERE `rsppoint` is NOT NULL ORDER BY `rsppoint` DESC";
        ...
        try {
            ...
            while(rs.next()) {
                 ...
                 points[count] = rs.getString("rsppoint");
