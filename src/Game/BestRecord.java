...
public class BestRecord extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        label1.setText("축하합니다 최고기록을 갱신하셨어요!!");
        label1.setToolTipText("게임설명");
        jPanel2.add(label1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 41, 363, 72));

        recordLabel.setFont(new java.awt.Font("굴림", 1, 36)); // NOI18N
        recordLabel.setForeground(new java.awt.Color(255, 102, 102));
        ...
        jPanel2.add(recordLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 118, 363, 70));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/animat-pencil-color.gif"))); // NOI18N
        jLabel1.setText("jLabel1");
        jPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 250, 47, 71));

        jLabel2.setFont(new java.awt.Font("굴림", 1, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 102, 102));
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setText("(+100)");
        jPanel2.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 220, 96, 40));

        Point.setFont(new java.awt.Font("굴림", 1, 18)); // NOI18N
        Point.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        Point.setText("포인트");
        jPanel2.add(Point, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 190, 220, 30));
        ...
        setSize(new java.awt.Dimension(530, 531));
    ...
    private void MinimizeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_MinimizeMouseClicked
        ...
        this.setState(BestRecord.ICONIFIED);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BestRecord.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BestRecord().setVisible(true);
            }
        });
    }
