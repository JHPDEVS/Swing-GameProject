...
public class NotRecord2 extends javax.swing.JFrame {
    ...
    public NotRecord2() {
       ...
       getRank();
       getPoint();
       count = String.valueOf(game.getCount());
       currentPoint.setText(count);
    ...
    private void MinimizeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_MinimizeMouseClicked
        ...
        this.setState(NotRecord2.ICONIFIED);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NotRecord2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NotRecord2().setVisible(true);
            }
        });
    }
